...
| t | Screen | VO |
|---|---|---|
| 0:00–0:04 | store.shangdian.me checkout (QR / USDT screenshot) | "This shop still collects USDT with a QR code." |
| 0:04–0:08 | Paste `<script src="agentpay.js">`, reload, green **agent-ready · x402** badge | "One script. The catalog is now agent-readable." |
...
| 0:36–0:40 | End card: AgentPay · Track A · GitHub URL | "AgentPay. Track A. GitHub in the post." |
